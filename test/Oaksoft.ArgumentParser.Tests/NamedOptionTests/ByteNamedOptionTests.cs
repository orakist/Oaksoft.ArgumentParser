...
public class ByteNamedOptionTests : ArgumentParserTestBase
{
    [Theory]
    ...
    public void ParseScalarOption_WhenArgumentsValid_WithDefaultValues(byte val1, byte val2, params string[] args)
    {
        // Arrange
        var sut = CommandLine.CreateParser<ByteAppOptions>()
            .AddNamedOption(s => s.Value, o => o.WithDefaultValue((byte)11), mustHaveOneValue: false)
            .AddNamedOption(s => s.NullValue, o => o.WithDefaultValue((byte)55), mustHaveOneValue: false)
            .Build();
