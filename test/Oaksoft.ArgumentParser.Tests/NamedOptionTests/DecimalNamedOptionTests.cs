...
public class DecimalNamedOptionTests
{
    [Theory]
    ...
    [InlineData(-50, 120, "/v=-50", "/null-value:120")]
    [InlineData(4, 2, "/null-value", "2", "/v", "4")]
    public void ParseScalarOption_WhenArgumentsValid_WithFlagProps(decimal val1, decimal val2, params string[] args)
    {
        // Arrange
        var sut = CommandLine.CreateParser<DecimalAppOptions>()
    ...
    public void ParseScalarOption_WhenArgumentsValid_WithFlagPropsAndDefaultValues(decimal val1, decimal val2, params string[] args)
    {
        // Arrange
        var sut = CommandLine.CreateParser<DecimalAppOptions>()
            .AddNamedOption(s => s.Value, s => s.ValueFlag, o => o.WithDefaultValue((decimal)11), mustHaveOneValue: false)
            .AddNamedOption(s => s.NullValue, s => s.NullValueFlag, o => o.WithDefaultValue((decimal)55), mustHaveOneValue: false)
            .Build();
