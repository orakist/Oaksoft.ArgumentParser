...
public class DoubleNamedOptionTests : ArgumentParserTestBase
{
    [Theory]
    ...
    public void ParseScalarOption_WhenArgumentsValid_WithDefaultValues(double val1, double val2, params string[] args)
    {
        // Arrange
        var sut = CommandLine.CreateParser<DoubleAppOptions>()
