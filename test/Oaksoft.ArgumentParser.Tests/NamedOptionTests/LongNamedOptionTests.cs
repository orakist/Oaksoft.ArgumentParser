...
public class LongNamedOptionTests : ArgumentParserTestBase
{
    [Theory]
    ...
    public void ParseScalarOption_WhenArgumentsValid_WithDefaultValues(long val1, long val2, params string[] args)
    {
        // Arrange
        var sut = CommandLine.CreateParser<LongAppOptions>()
