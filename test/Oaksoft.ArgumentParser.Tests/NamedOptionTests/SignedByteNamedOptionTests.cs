...
public class SignedByteNamedOptionTests
{
    [Theory]
    ...
    [InlineData(-50, 120, "/v=-50", "/null-value:120")]
    [InlineData(4, 2, "/null-value", "2", "/v", "4")]
    public void ParseScalarOption_WhenArgumentsValid_WithFlagProps(sbyte val1, sbyte val2, params string[] args)
    {
        // Arrange
        var sut = CommandLine.CreateParser<SignedByteAppOptions>()
    ...
    public void ParseScalarOption_WhenArgumentsValid_WithFlagPropsAndDefaultValues(sbyte val1, sbyte val2, params string[] args)
    {
        // Arrange
        var sut = CommandLine.CreateParser<SignedByteAppOptions>()
            .AddNamedOption(s => s.Value, s => s.ValueFlag, o => o.WithDefaultValue((sbyte)11), mustHaveOneValue: false)
            .AddNamedOption(s => s.NullValue, s => s.NullValueFlag, o => o.WithDefaultValue((sbyte)55), mustHaveOneValue: false)
            .Build();
    ...
    [InlineData(new sbyte[] { 10, 12, 14 }, new sbyte[] { 16 }, "-v10;12", "/v=14", "/null-values:16")]
    [InlineData(new sbyte[] { 6, 8, 10 }, new sbyte[] { 2, 4 }, "/null-values", "2,4", "-v6", "/v", "8|10")]
    public void ParseSequentialOption_WhenArgumentsValid_WithCount(sbyte[] val1, sbyte[] val2, params string[] args)
    {
        // Arrange
        var sut = CommandLine.CreateParser<SignedByteAppOptions>()
