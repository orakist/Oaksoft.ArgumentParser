...
public class UnsignedLongNamedOptionTests
{
    ...
    [InlineData(50, 250, "/v=50", "/null-value:250")]
    [InlineData(4, 2, "/null-value", "2", "/v", "4")]
    public void ParseScalarOption_WhenArgumentsValid_WithFlagProps(ulong val1, ulong val2, params string[] args)
    {
        // Arrange
        var sut = CommandLine.CreateParser<UnsignedLongAppOptions>()
    ...
    public void ParseScalarOption_WhenArgumentsValid_WithFlagPropsAndDefaultValues(ulong val1, ulong val2, params string[] args)
    {
        // Arrange
        var sut = CommandLine.CreateParser<UnsignedLongAppOptions>()
            .AddNamedOption(s => s.Value, s => s.ValueFlag, o => o.WithDefaultValue((ulong)11), mustHaveOneValue: false)
            .AddNamedOption(s => s.NullValue, s => s.NullValueFlag, o => o.WithDefaultValue((ulong)55), mustHaveOneValue: false)
            .Build();
    ...
    [InlineData(new ulong[] { 10, 12, 14 }, new ulong[] { 16 }, "-v10;12", "/v=14", "/null-values:16")]
    [InlineData(new ulong[] { 6, 8, 10 }, new ulong[] { 2, 4 }, "/null-values", "2,4", "-v6", "/v", "8|10")]
    public void ParseSequentialOption_WhenArgumentsValid_WithCount(ulong[] val1, ulong[] val2, params string[] args)
    {
        // Arrange
        var sut = CommandLine.CreateParser<UnsignedLongAppOptions>()
